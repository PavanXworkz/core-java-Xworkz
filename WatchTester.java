class WatchTester{
	public static void main(String [] tt){
		...
		time.color="silver";
		time.giveTime();
		System.out.println("Type="+time.type+"Brand Name="+time.brandName+"Price="+time.price+"Colour"+time.color);
		...
		time1.color="White";
		time1.giveTime();
		System.out.println("Type="+time1.type+"Brand Name="+time1.brandName+"Price="+time1.price+"Colour"+time1.color);
