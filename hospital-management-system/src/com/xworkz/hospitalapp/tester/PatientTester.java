...
//    hospital.addPatient(patient5);
    ...
    do {
      System.out.println("1:get all the patient details. \n2:Get patient detils by address. \n3:get patient by address \n4:get patient name by ward number \n5:get patient name by diesease name \n6:update patient diesease by patient id \n7:update patient ward no by patient id \n8:update patient age by patient id \n9:get patient age by id \n10:get patient attender name by patient id");
      ...
      switch (choice) {
        ...
        case 3:
          ...
          try {
           String getPatientNameByWardNo= hospital.getPatientNameByWardNo(sc.next());
          }catch(WardNotFoundException wnfe){
            wnfe.printStackTrace();
          
        }
          break;
        case 4:
          System.out.println("enter diesease name of the patient");
          String[] patientNameByDieseaseName = hospital.getPatientNameByDieseaseName(sc.next());
          for (String patientName : patientNameByDieseaseName) {
