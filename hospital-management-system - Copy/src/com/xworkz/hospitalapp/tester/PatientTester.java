...
//    hospital.addPatient(patient5);
    ...
    do {
      System.out.println("1:get all the patient details. \n2:Get patient detils by address. \n3:get patient by address \n4:get patient name by ward number \n4:get patient name by diesease name \n5:update patient diesease by patient id \n6:update patient ward no by patient id \n7:update patient age by patient id \n8:get patient age by id \n9:get patient attender name by patient id");
